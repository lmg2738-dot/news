import { getRedisInstanceId, getRedisStateKey } from "../lib/instance";
...
async function main() {
  ...
  console.log("=== 뉴스 상태 진단 ===\n");
  console.log("Redis instanceId:", getRedisInstanceId());
  console.log("Redis key:", getRedisStateKey());
